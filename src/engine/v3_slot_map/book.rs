...
use crate::{
    ...
    slot_map::{SlotMap, optimized::OptimizedSlotMap},
};

pub struct OrderBook {
    pub(crate) bids: BTreeMap<Reverse<u64>, OptimizedSlotMap<OrderIdU32>>,
    pub(crate) asks: BTreeMap<u64, OptimizedSlotMap<OrderIdU32>>,
    pub(crate) orders: OptimizedSlotMap<LimitOrder<OrderIdU32>>,
}
