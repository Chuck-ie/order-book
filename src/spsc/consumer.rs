...
//     }
//
//     // pub fn try_recv_2(&self) -> Result<T, Error> {
//     //     let curr_tail = self.inner_tail.get();
//     //     let curr_cl_tail = self.inner_cl_tail.get();
//     //     let curr_tail_idx = (curr_tail * N) + curr_cl_tail;
//     //     let mut cached_head_idx = self.cached_head_idx.get();
//     //
//     //     if curr_tail_idx == cached_head_idx {
//     //         let curr_head = self.buffer.head.load(Ordering::Acquire);
//     //         let curr_cl_head = self.buffer.load_inner_cl_head_ptr();
//     //         let new_head_idx = (curr_head * N) + curr_cl_head;
//     //         cached_head_idx = new_head_idx;
//     //
//     //         self.cached_head_idx.set(new_head_idx);
//     //     }
//     //
//     //     if curr_tail_idx == cached_head_idx {
