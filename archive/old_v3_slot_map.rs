// use crate::{
//     common::{LimitOrder, LimitOrderRequest, OrderBookExt, OrderIdU32, OrderMatcherExt, OrderSide},
//     slot_map::{SlotMap, standard::SlotMapStandard},
// };
// use std::{cmp::Reverse, collections::BTreeMap};
//
// pub struct OrderBook {
//     bids: BTreeMap<Reverse<u64>, SlotMapStandard<OrderIdU32>>,
//     asks: BTreeMap<u64, SlotMapStandard<OrderIdU32>>,
//     orders: SlotMapStandard<LimitOrder<OrderIdU32>>,
// }
//
...
//         let order = self
//             .orders
//             .get_mut(new_order_id.0 as usize)
